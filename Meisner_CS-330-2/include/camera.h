...
public:
    ...
    {
        /*
        * Increases the movement speed on the mouse scroll, if MovementSpeed rises above 20, output a message and reset.
        */
        if (MovementSpeed <= 20)
        {
            MovementSpeed++;
        ...
        else MovementSpeed = 2.5 && std::cout << "You went too fast!" << std::endl;
